(function(i) {
        ...
        function(c, b) {
            if (i.isPlainObject(b)) {
                ...
                if (s) {
                    ...
                    f = 0;
                    for (h = m.length; f < h; f++) g = b.createAttribute(m[f].name.replace(":", "_dt_b_namespace_token_")),
                    g.value = m[f].value,
                    e.setAttributeNode(g)
                }
                e = v.serializeToString(b);
                s && ( - 1 === e.indexOf("<?xml") && (e = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + e), e = e.replace(/_dt_b_namespace_token_/g, ":"));
    ...
    function n(a, c, d) {
        ...
        d && (d.attr && i(b).attr(d.attr), d.children && i.each(d.children,
        function(a, c) {
            b.appendChild(c)
    ...
    function I(a, c) {
        ...
        for (var e = 0,
        f = a.body.length; e < f && !(b = a.body[e][c].toString(), -1 !== b.indexOf("\n") ? (b = b.split("\n"), b.sort(function(a, b) {
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) o = void 0;
        ...
        L = function(a) { (h.setImmediate || h.setTimeout)(function() {
                throw a;
            },
            0)
        },
        ...
        D = function(a, c, d) {
            ...
            b.readyState = b.INIT;
            if (J) e = (h.URL || h.webkitURL || h).createObjectURL(a),
            setTimeout(function() {
                t.href = e;
                t.download = c;
                ...
                i.readAsDataURL(a);
                b.readyState = b.INIT
            } else e || (e = (h.URL || h.webkitURL || h).createObjectURL(a)),
        ...
        j.readyState = j.INIT = 0, j.WRITING = 1, j.DONE = 2, j.error = j.onwritestart = j.onprogress = j.onwrite = j.onabort = j.onerror = j.onwriteend = null, o = function(a, c, d) {
    ...
    F = function(a, c) {
        for (var d = E(c), b = a.buttons.exportData(c.exportOptions), e = c.fieldBoundary, f = c.fieldSeparator, i = RegExp(e, "g"), m = c.escapeChar !== p ? c.escapeChar: "\\", h = function(a) {
            for (var b = "",
            c = 0,
            d = a.length; c < d; c++) 0 < c && (b += f),
            b += e ? e + ("" + a[c]).replace(i, m + e) + e: a[c];
            return b
        },
        g = c.header ? h(b.header) + d: "", k = c.footer && b.footer ? d + h(b.footer) : "", w = [], x = 0, j = b.body.length; x < j; x++) w.push(h(b.body[x]));
        return {
            str: g + w.join(d) + k,
            rows: w.length
        }
    ...
    l.ext.buttons.excelHtml5 = {
        ...
        action: function(a, c, d, b) {
            ...
            d = function(a) {
                ...
                c = a.length; b < c; b++) {
                    for (var d = b,
                    g = ""; 0 <= d;) g = String.fromCharCode(d % 26 + 65) + g,
                    d = Math.floor(d / 26) - 1;
                    var d = g + "" + m,
                    j = null;
                    if (! (null === a[b] || a[b] === p || "" === a[b])) {
                        a[b] = i.trim(a[b]);
                        for (var l = 0,
                        o = H.length; l < o; l++) if (g = H[l], a[b].match && a[b].match(g.match)) {
                            j = a[b].replace(/[^\d\.\-]/g, "");
                            g.fmt && (j = g.fmt(j));
                            j = n(f, "c", {
                                attr: {
            ...
            for (var j = 0,
            l = c.body.length; j < l; j++) d(c.body[j], e);
    ...
    l.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, c, d, b) {
            ...
            e = [];
            b.header && e.push(i.map(a.header,
            function(a) {
                return {
            ...
            for (var f = 0,
            h = a.body.length; f < h; f++) e.push(i.map(a.body[f],
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
            ...
            b.footer && a.footer && e.push(i.map(a.footer,
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
                    style: "tableFooter"
