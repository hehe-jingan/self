...
(function(Fa, T, k) {
    var S = function(g) {
        ...
        function ka(a, b, c) {
            ...
            c = -1 !== g.inArray("desc", b.asSorting); ! b.bSortable || !a && !c ? (b.sSortingClass = d.sSortableNone, b.sSortingClassJUI = "") : a && !c ? (b.sSortingClass = d.sSortableAsc, b.sSortingClassJUI = d.sSortJUIAscAllowed) : !a && c ? (b.sSortingClass = d.sSortableDesc, b.sSortingClassJUI = d.sSortJUIDescAllowed) : (b.sSortingClass = d.sSortable, b.sSortingClassJUI = d.sSortJUI)
        }
        function Y(a) {
        ...
        function L(a, b, c, d) {
            ...
            i = 0,
            j = h.length; i < j; i++) c && Ja(a, e, i, y(a, e, i)),
            h[i].sType = null;
            a.aiDisplayMaster.push(e);
            b = a.rowIdFn(b);
            b !== k && (a.aIds[b] = f); (c || !a.oFeatures.bDeferRender) && Ka(a, e, c, d);
            return e
        }
        function ma(a, b) {
            var c;
        ...
        function kb(a) {
            ...
            j && d.appendTo(e),
            a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Pa(a, f.nTh, b))),
            ...
            if (b) {
                ...
                for (e = h.length; d < e; d++) {
                    ...
                    for (b = h[d].length; f < b; f++) if (n = j = 1, i[d][f] === k) {
                        ...
                        for (i[d][f] = 1; h[d + j] !== k && h[d][f].cell == h[d + j][f].cell;) i[d + j][f] = 1,
                        j++;
        ...
        function ub(a) {
            ...
            q("mDataProp_" + h, j),
            d.bFilter && (q("sSearch_" + h, l.sSearch), q("bRegex_" + h, l.bRegex), q("bSearchable_" + h, n.bSearchable)),
        ...
        function pb(a) {
            ...
            j = g("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", h ? ua(f, h) : f).bind("keypress.DT",
            function(a) {
        ...
        function yb(a) {
            ...
            d, e, f = 0,
            h = b.length; f < h; f++) {
                for (var i = [], j = 0, g = c.length; j < g; j++) e = c[j],
                d = a.aoData[e],
        ...
        function xb(a, b, c, d, e, f) {
            ...
            d = Ra(b, d, e, f), e = h.length - 1; 0 <= e; e--) b = a.aoData[h[e]]._aFilterData[c],
        ...
        function zb(a) {
            ...
            for (f = a.aoData.length; d < f; d++) if (g = a.aoData[d], !g._aFilterData) {
                ...
                c.bSearchable ? (j = y(a, d, e, "filter"), l[c.sType] && (j = l[c.sType](j)), null === j && (j = ""), "string" !== typeof j && j.toString && (j = j.toString())) : j = "",
        ...
        function ob(a) {
            ...
            c = a.sTableId,
            d = a.aLengthMenu,
            e = g.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = g("<select/>", {
                name: c + "_length",
                "aria-controls": c,
        ...
        function Ha(a) {
            ...
            if (d || !q && !f && !e && i == ba(a) && i == n.length) for (m = 0; m < i; m++) c[m].sWidth = u(n.eq(m).width());
                ...
                if (f) {
                    ...
                    e = p.bBounding ? n[m].getBoundingClientRect().width: g(n[m]).outerWidth(),
                    h += null === o.sWidthOrig ? e: parseInt(o.sWidth, 10) + e - g(n[m]).width();
                    i.width(u(h));
                    b.style.width = u(h)
                }
        ...
        function Kb(a) {
            ...
            e = V(a), a = a.oLanguage.oAria, f = 0, h = d.length; f < h; f++) {
                c = d[f];
                var i = c.asSorting;
        ...
        function Jb(a, b) {
            ...
            for (var f, h = m.ext.type.order[c.sType + "-pre"], i = 0, g = a.aoData.length; i < g; i++) if (c = a.aoData[i], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f = d ? e[i] : y(a, i, b, "sort"),
        ...
        function Lb(a) {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (e && e.time && (b = w(a, "aoStateLoadParams", "stateLoadParams", [a, e]), -1 === g.inArray(!1, b) && (b = a.iStateDuration, !(0 < b && e.time < +new Date - 1E3 * b) && d.length === e.columns.length))) {
                    ...
                    e.order !== k && (a.aaSorting = [], g.each(e.order,
                    function(b, c) {
        ...
        m = function(a) {
            ...
            this.fnAddData = function(a, b) {
                var c = this.api(!0),
                d = g.isArray(a) && (g.isArray(a[0]) || g.isPlainObject(a[0])) ? c.rows.add(a) : c.row.add(a); (b === k || b) && c.draw();
            ...
            this.fnDeleteRow = function(a, b, c) {
                ...
                g = e.aoData[a[0][0]];
                a.remove();
                b && b.call(this, e, g); (c === k || c) && d.draw();
                return g
            };
            ...
            this.fnUpdate = function(a, b, c, d, e) {
                var g = this.api(!0);
                c === k || null === c ? g.row(b).data(a) : g.cell(b, c).data(a); (e === k || e) && g.columns.adjust(); (d === k || d) && g.draw();
                return 0
            };
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) J(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    F(o.oScroll, f, [["sScrollX", "sX"], ["sScrollXInner", "sXInner"], ["sScrollY", "sY"], ["bScrollCollapse", "bCollapse"]]);
                    ...
                    s = r.children("tbody").find("tr").eq(0); - 1 !== g.inArray(!0, g.map(e,
                    function(a) {
                        return s.hasClass(a)
        ...
        t = function(a, b) {
            ...
            var c = [],
            d = function(a) { (a = dc(a)) && c.push.apply(c, a)
            };
        ...
        t.register = p = function(a, b) {
            ...
            else for (var e = a.split("."), f = Ub, h, i, c = 0, d = e.length; c < d; c++) {
        ...
        function(a) {
            ...
            function(b) {
                ...
                c.nodeName && "TR" === c.nodeName.toUpperCase() ? i.push(ma(b, c)[0]) : i.push(L(b, c));
                return i
            },
            1),
            c = this.rows( - 1);
        ...
        Wb = function(a, b) {
            ...
            if (c.length && a.length) {
                ...
                if (d._details) { (d._detailsShow = b) ? d._details.insertAfter(d.nTr) : d._details.detach();
                    ...
                    function(a, b) {
                        if (e === b) for (var c, d = ba(b), f = 0, k = g.length; f < k; f++) c = g[f],
        ...
        function(a, b, c, d) {
            ...
            function(e) {
                e.oFeatures.bFilter && ga(e, g.extend({},
                e.oPreviousSearch, {
                    sSearch: a + "",
                    bRegex: null === b ? !1 : b,
                    bSmart: null === c ? !0 : c,
        ...
        function(a) {
            ...
            function(b) {
                ...
                h = a ? "remove": "detach";
                j[h]();
                k[h](); ! a && c && (c.insertBefore(e, b.nTableReinsertBefore), j.css("width", b.sDestroyWidth).removeClass(d.sTable), (p = b.asDestroyStripes.length) && f.children().each(function(a) {
    ...
    var S = function(g) {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sEmptyTable: "没有记录",
                sInfo: "显示 _START_ 到 _END_ 一共 _TOTAL_ 记录",
                sInfoEmpty: "显示 0 到 0 一共 0 记录",
                sInfoFiltered: "(filtered from _MAX_ total entries)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "一共有 _MENU_ 记录",
                sLoadingRecords: "Loading...",
                sProcessing: "Processing...",
                sSearch: "查找:",
                sSearchPlaceholder: "",
