...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	if(request.getSession().getAttribute("student")==null){
		...
		userLoginFlag = "true";
		user = (Student)request.getSession().getAttribute("student");
...
// 	  getMessageCount();
	  if(userIsLoginFlag=="false"){
		  alert("请重新登录！！");
		  window.location.href = "<%=basePath%>student/login";
	  }
	  
	  $("#logoutSystem").click(function(){
		  
		 if(confirm("确定要退出系统吗？？")){
			 window.location.href = "<%=basePath%>student/login?flag=logout";
		 }
