...
<%@include file="model/teaHeader.jsp"%>
</head>
<% 
...
if(request.getAttribute("userInfo")!=null){
	userInfo = (Teacher)request.getAttribute("userInfo");
	 pageFlag = "true";
}
...
<body>
	<!-- Left Panel -->
	<%@include file="model/teaMenu.jsp"%>
	<!-- /#left-panel -->
	<!-- Right Panel -->
	<div id="right-panel" class="right-panel">
		<!-- Header-->
		<%@include file="model/teaTitle.jsp"%>
		<!-- /#header -->
		<!-- Content -->
		<div class="content">
							...
							<div id="pay-invoice">
								<div class="card-body col-md-3">
									<form action="#" method="post" novalidate="novalidate"
										...
										<div class="form-group">
											<label for="cc-payment" class="control-label mb-1">邮箱</label>
											<input type="text" id="" name="" disabled
												class="form-control" aria-required="true"
												aria-invalid="false" value="<%=userInfo.getEmail()%>">
										</div>
										<br />
										<div>
...
<!-- 											</button> -->
    ...
    $(document).ready(function() {
   	 ...
   	 $("#returnBack").click(function(){
   		window.location = "<%=basePath%>teacher/index";
   	 });
    });
    </script>
</body>
