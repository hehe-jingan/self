                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">已借阅列表</strong>
                            </div>
                            <div class="card-body">
                  ...
                  %>
                                        <tr>
                                            ...
                                            <a href="<%=basePath%>user/bookDetail/<%=list.get(i).get("bookId")%>" >详情</a>
                                             <a href="#" id="reNew<%=list.get(i).get("borrowId")%>" >在线续借</a>
...
<script type="text/javascript">
     ...
     $(document).ready(function() {
    	 ...
    	 $("a[id^='reNew']").click(function(){
    		 ...
    		 if(confirm("确定要在线续借这本书15天吗？")){
    		 
    		 var id = $(this).prop("id").substring(5);
    		 var url = "<%=basePath%>user/reNewBook";
