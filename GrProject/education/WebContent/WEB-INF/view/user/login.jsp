                ...
                <div class="login-form">
                    <form id="adminLoginForm">
                        <div class="form-group">
                            <label>账号</label>
                            <input type="text" class="form-control" placeholder="请输入账号\图书卡号\身份证号" name="name" id="name"  value="张三">
                        </div>
                        <div class="form-group">
                            <label>密码</label>
                        ...
                        <br/> <br/>
                        <button type="button" id="register" class="btn btn-info btn-flat m-b-30 m-t-30">注册</button>
                        <br/> <br/>
                        <button type="button" id="returnBack" class="btn btn-secondary btn-flat m-b-30 m-t-30">返回</button>
