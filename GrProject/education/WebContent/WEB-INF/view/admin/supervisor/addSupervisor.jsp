...
<head>
 ...
 <%String superNo = "";
if(request.getAttribute("superNo")!=null){
	superNo = (String)request.getAttribute("superNo");
}
%>
</head>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">新增督导</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <form action="#" method="post" novalidate="novalidate" id="form5">
											...
											<input type="text" id="" name="" disabled="disabled"
												...
												aria-invalid="false" value="<%=superNo%>">
												<input  type="hidden" name="spare1" value="<%=superNo%>"/> 
										</div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1" >账号</label>
                                                <input type="text"  id="supervisorName" name="supervisorName" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1" >密码</label>
                                                <input type="password" id="supervisorPass" name="supervisorPass" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
    ...
    $(document).ready(function() {
   	 ...
   	 $("#makeSure").click(function(){
   		var supervisorName = $("#supervisorName").val();
   		 var supervisorPass = $("#supervisorPass").val();
   		 ...
   		 if(supervisorName==""){
   			 ...
   			 alert("请输入确认密码！");
   		 }else if(confirm!=supervisorPass){
   			 alert("输入密码与确认密码不一致！");
   		 }else{ 
   			 var data = decodeURIComponent($("#form5").serialize(),true);
   			 console.log("data= "+data);
   			 var url = "<%=basePath%>admin/addSupervisor";
   			 ...
   			 $.ajax({
   			       	...
   			       	success : function(data){
   			       		if(data.msg=="SUCCESS"){
   			       			alert("新增成功！！");
   			       			window.location = "<%=basePath%>admin/supervisorList";
   			       		}else{
   			       			alert(data.msg);
   			       		}
   			      	}
