...
List<Supervisor> list = null;
    if(request.getAttribute("supervisorList")!=null){
    	list = (List<Supervisor>)request.getAttribute("supervisorList");
    }
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">督导列表</strong>
                                  <span class="btn btn-lg btn-outline-secondary float-right" id="addSupervisorBtn">新增督导</span> 
                            </div>
                            <div class="card-body">
...
<!--             <br/><br/> -->
	...
	<div class="am-modal-dialog">确认删除该督导？
...
//     	 $("#menu3").addClass("active");
    	 ...
    	 $("#addSupervisorBtn").click(function(){
    		 window.location.href = "<%=basePath%>admin/addSupervisor";
    	 });
    	 
    	 $("a[id^='deleteSupervisorBtn']").click(function(){
    	 ...
    	 $("#makeSure").click(function(){
    		 ...
    		 var url = "<%=basePath%>admin/deleteSupervisor";
