            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">用户列表</strong>
                                  <span class="btn btn-outline-secondary float-right" id="addAdminBtn">新增用户</span> 
                            </div>
                            <div class="card-body">
                  ...
                  %>
                                        <tr>
                                            <td><%=i+1 %></td>
                                            <td><%=list.get(i).getCertno() %></td>
                                            <td><%=list.get(i).getName() %></td>
                                            <td><%=list.get(i).getSex() %></td>
                                            <td><%=list.get(i).getAge() %></td>
                                            <td><%=list.get(i).getIdcard() %></td>
                                            <td><%=list.get(i).getInputdate()==null?"暂未注册":sdf.format(list.get(i).getInputdate()) %></td>
                                            <td><%=list.get(i).getLastlogindate()==null?"暂未登录":sdf.format(list.get(i).getLastlogindate()) %></td>
                                            <td><a href="#" id="deleteAdminBtn<%=list.get(i).getId() %>" data-am-modal="{closeOnConfirm	: false,target: '#deleteAd', closeViaDimmer: 0, width: 400, height: 125}">删除</a>
                                       </td>
                                        </tr>
                                        <%}
                  	} %>
...
<!--             <br/><br/> -->
	...
	<div class="am-modal-dialog">确认删除该用户？
...
//     	 $("#menu3").addClass("active");
    	 ...
    	 $("#addAdminBtn").click(function(){
    		 window.location.href = "<%=basePath%>admin/addUser";
    	 });
    	 ...
    	 $("#makeSure").click(function(){
    		 ...
    		 var url = "<%=basePath%>admin/deleteUser";
