                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">新增用户</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <form action="#" method="post" novalidate="novalidate" id="form5">
                                            ...
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1" >卡号</label>
                                                <input type="text"  id="certNo" name="certNo" class="form-control" aria-required="true" aria-invalid="false" disabled="disabled" value="${newCertId }">
                                            </div>
                                             <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1" >姓名</label>
                                                <input type="text"  id="name" name="name" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
...
<!--                                                 <input type="number"  class="form-control" aria-required="true" aria-invalid="false" value=""> -->
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1" >年龄</label>
                                                <input type="text"  id="age" name="age" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1" >身份证</label>
                                                <input type="text"  id="idcard" name="idcard" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1" >密码</label>
                                                <input type="password" id="pass" name="pass" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
   	 ...
   	 $("#makeSure").click(function(){
   		...
   		var age = $("#age").val();
   		 ...
   		 if(adminName==""){
   			 ...
   			 console.log("data= "+data+"&certNo="+newCertNo);
   			 var url = "<%=basePath%>admin/addUser";
   			 
   			 $.ajax({
   			       	type : "POST",
   			       	url : url,
   			       	data : data+"&certNo="+newCertNo,
   			       	dataType : "json",
   			       	success : function(data){
   			       		if(data.msg=="SUCCESS"){
   			       			alert("新增成功！！");
