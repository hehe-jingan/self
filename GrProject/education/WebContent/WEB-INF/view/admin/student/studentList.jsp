                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">学生列表</strong>
                                  <span class="btn btn-lg btn-outline-secondary float-right" id="addStudentBtn">新增学生</span> 
                            </div>
                            <div class="card-body">
                  ...
                  %>
                                        <tr>
                                            ...
                                            <td><%=list.get(i).getName() %></td>
                                             ...
                                             <td><%=("0".equals(list.get(i).getClassid()+""))?"暂未分配":list.get(i).getClasses().getName() %></td>
...
<%--                                             <td><%=list.get(i).getLastlogindate()==null?"暂未登录":sdf.format(list.get(i).getLastlogindate()) %></td> --%>
                                             <td>
                                              <a href="<%=basePath%>admin/updateStudent/<%=list.get(i).getIndexid()%>" >编辑</a>
                                             <a href="#" id="deleteStudentBtn<%=list.get(i).getIndexid() %>" data-am-modal="{closeOnConfirm	: false,target: '#deleteAd', closeViaDimmer: 0, width: 400, height: 125}">删除</a>
                                        </tr>
                                        <%}
                  	} %>
                                    </tbody>
...
<!--             <br/><br/> -->
	...
	<div class="am-modal-dialog">确认删除该学生？
...
//     	 $("#menu3").addClass("active");
    	 ...
    	 $("#makeSure").click(function(){
    		 ...
    		 var url = "<%=basePath%>admin/deleteStudent";
    		 $.ajax({
    		       	type : "POST",
    		       	url : url,
    		       	data : data,
