                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">可借书籍列表</strong>
<!--                                   <span class="btn btn-outline-secondary float-right" id="addAdminBtn">书籍入库</span>  -->
                            </div>
                            <div class="card-body">
                  ...
                  %>
                                        <tr>
                                            ...
                                            <a href="<%=basePath%>main/bookDetail/<%=list.get(i).getId()%>" >详情</a>
                                             <a href="<%=basePath%>admin/borrowBook/<%=list.get(i).getId()%>" >借阅</a>
                                            </a>
                                            </td>
                                        </tr>
                                        <%}
