...
INSERT INTO `admin` (`indexId`, `name`, `pass`, `lastLoginDate`, `spare1`, `spare2`) VALUES
	(1, 'admin', 'admin', '2020-03-26 00:40:22', NULL, NULL),
...
-- Dumping structure for table education.message
CREATE TABLE IF NOT EXISTS `message` (
  `messageId` int(11) NOT NULL AUTO_INCREMENT,
  `messType` varchar(50) DEFAULT NULL COMMENT '管理员、用户',
  `messId` int(11) DEFAULT NULL COMMENT '通知人Id',
  `content` varchar(50) DEFAULT NULL COMMENT '通知内容',
  `messFlag` varchar(50) DEFAULT NULL COMMENT '是否已读',
  PRIMARY KEY (`messageId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='通知表';

-- Dumping data for table education.message: ~1 rows (approximately)
DELETE FROM `message`;
/*!40000 ALTER TABLE `message` DISABLE KEYS */;
INSERT INTO `message` (`messageId`, `messType`, `messId`, `content`, `messFlag`) VALUES
	(1, '管理员', 1, '呵呵', '未读');
...
INSERT INTO `student` (`indexId`, `name`, `sex`, `age`, `pass`, `classId`, `inputDate`, `inputName`, `modifyDate`, `modifyName`, `spare1`, `spare2`) VALUES
	(1, '张三', '男', '21', '123', 1, '2020-03-25 23:17:49', 'admin', '2020-03-25 23:32:38', 'admin', NULL, NULL),
	(2, '李四', '女', '19', '123', 1, '2020-03-25 23:39:09', 'admin', '2020-03-25 23:39:26', 'admin', NULL, NULL);
