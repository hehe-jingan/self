...
INSERT INTO `admin` (`indexId`, `name`, `pass`, `lastLoginDate`, `spare1`, `spare2`) VALUES
	(1, 'admin', 'admin', '2020-03-31 00:39:31', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `class_arrange` (
  ...
  `spare2` varchar(50) DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`indexId`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='班级课程关联表';

-- 正在导出表  education.class_arrange 的数据：~5 rows (大约)
...
CREATE TABLE IF NOT EXISTS `course_arrange` (
  ...
  `spare2` varchar(50) DEFAULT NULL COMMENT '备用字段2',
  PRIMARY KEY (`indexId`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='课程安排表';
...
-- 正在导出表  education.evaluation 的数据：~3 rows (大约)
...
INSERT INTO `evaluation` (`indexId`, `sid`, `caid`, `score`, `content`, `year`, `is_delete`, `inputDate`, `inputName`, `modifyDate`, `modifyName`, `spare1`, `spare2`) VALUES
	(2, 1, 3, 8.0, '很有意思的一次课程体验！！', '201902', '0', '2020-03-29 23:45:35', '张三', '2020-03-30 23:38:08', 'admin', NULL, NULL),
	(3, 1, 2, 10.0, '老师讲得好~生动形象很到位', '201901', '0', '2020-03-30 00:47:18', '张三', NULL, NULL, NULL, NULL),
	(4, 3, 1, 10.0, '讲得好！印象深刻！', '201801', '0', '2020-03-30 01:10:07', '王五', NULL, NULL, NULL, NULL);
...
INSERT INTO `student` (`indexId`, `name`, `sex`, `age`, `pass`, `classId`, `inputDate`, `inputName`, `modifyDate`, `modifyName`, `spare1`, `spare2`) VALUES
	...
	(2, '李四', '女', '19', '123', 0, '2020-03-25 23:39:09', 'admin', '2020-03-27 02:23:53', 'admin', '120032502', NULL),
...
-- 正在导出表  education.supervisor 的数据：~0 rows (大约)
